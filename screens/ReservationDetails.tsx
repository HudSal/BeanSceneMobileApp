...
export function Details(props: any) {
    ...
    var personFirstName= route.params.firstName;
    var personLastName= route.params.lastName;
    //fetching a reservation based on its id
    useEffect(()=>{ fetch(`https://localhost:44377/API/Reservations/${newId}`)
    ...
    return (
        <View style={vStyles.container}>
            ...
            <View style={vStyles.form}>
                ...
                <Text style={vStyles.labelDetails}>Person Name: <Text style={vStyles.textDetails} > {personFirstName} {personLastName}</Text></Text>
